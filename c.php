                                ...
                                <div class="col-lg-6" style="padding-top : 150px">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">page verefi</h1>
                                            <div class="form-group">
                                                <input id="username" type="number" class="form-control form-control-user"
                                                    id="exampleInputEmail"
                                                    placeholder="Enter code .." name="numbercode">
                                            </div>
                                        <div class="text-center pt-2">
                                            <a class="small" href="home.php" name="ver_code">entrer</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
