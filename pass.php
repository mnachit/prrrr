                                    ...
                                    <div class="p-5">
                                        <div class="text-center">
                                            <?php if (isset($_SESSION['message'])){?>
                                                ...
                                                ?></div>
                                            <?php } ?>
                                            <?php if (isset($_SESSION['message_ver'])){?>
                                                <div class="alert alert-success" role="alert">
                                                <?php    echo $_SESSION['message_ver'];
                                                        unset( $_SESSION['message_ver']);
                                                ?>
                                                </div>
                                            <?php } ?>
                                        ...
                                        <form class="user" action="script.php" method="POST">
                                            <div class="form-group">
                                                <input id="username" name="logemailpass" type="email" class="form-control form-control-user"
                                        ...
                                        <div class="text-center pt-2">
                                            <a class="small" href="home.php" name="savecode">Page login</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
